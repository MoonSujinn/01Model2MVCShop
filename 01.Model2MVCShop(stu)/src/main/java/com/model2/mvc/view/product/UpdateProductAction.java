...
public class UpdateProductAction extends Action {
   ...
   public String execute(   HttpServletRequest request,
      ...
      if(FileUpload.isMultipartContent(request)) {
         ...
         String temDir=
        		 "C:\\Users\\bitcamp\\git\\01Model2MVCShop\\01.Model2MVCShop(stu)\\src\\main\\webapp\\images\\uploadFiles\\";
         //String temDir2="/uploadFile/";
         
         DiskFileUpload fileUpload = new DiskFileUpload();
         fileUpload.setRepositoryPath(temDir);
         //setSize Threshold의 크기를 벗어나게 되면 지정한 위치에 임시로 젖아한다.
         ...
         if(request.getContentLength()<fileUpload.getSizeMax()) {
            ...
            for (int i = 0; i < Size; i++) {
               ...
               //isFormFiled()를 통해서 파일 형식인지 파라미터인지 구분한다. 파라미터라면 true
               if(fileItem.isFormField()) {
                  ...
                  else if(fileItem.getFieldName().equals("prodDeatail"))
